...
# YOUR CODE HERE!
average_loan_price = (loan_sum / total_loans)
...
# YOUR CODE HERE!
future_value_2 = new_loan.get("future_value", 1000)
remaining_months_2 = new_loan.get("remaining_months", 12)
annual_discount_rate = 0.2
present_value_2 = future_value_2 / (1 + annual_discount_rate/12) ** remaining_months_2
# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
# YOUR CODE HERE!
print(f"The present value of the loan is: {present_value_2}")
...
# YOUR CODE HERE!
csvpath = Path("loan_values_as.csv")

print("loan analyzer as CSV file.")
